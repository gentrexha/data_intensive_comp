...
public class Parser {
    private final List<String> stopWords = Arrays.asList("as", "able", "about", "above", "according", "accordingly",
            "across", "actually", "after", "afterwards", "again", "against", "aint", "all", "allow", "allows",
            ...
            "apart", "appear", "appreciate", "appropriate", "are", "arent", "around", "as", "aside", "ask", "asking",
            ...
            "best", "better", "between", "beyond", "both", "brief", "but", "by", "cmon", "cs", "came", "can",
            ...
            "has", "hasnt", "have", "havent", "having", "he", "hes", "hello", "help", "hence", "her", "here",
            ...
            "lest", "let", "lets", "like", "liked", "likely", "little", "look", "looking", "looks", "ltd", "mainly",
            ...
            "very", "via", "viz", "vs", "want", "wants", "was", "wasnt", "way", "we", "wed", "well", "were",
            "weve", "welcome", "well", "went", "were", "werent", "what", "whats", "whatever", "when", "whence",
            ...
            "willing", "wish", "with", "within", "without", "wont", "wonder", "would", "wouldnt", "wouldve", "yes",
    ...
    public String[] parse(String input) {
        ...
        while (tokenizer.hasMoreTokens()) {
            ...
            token = token.toLowerCase()
                    .replaceAll("\\p{P}", "") //filter out punctuations
                    .replaceAll("@", "")
                    .replaceAll(":", "")
                    .replaceAll("[\\s]", " ")
                    .replaceAll("[^a-z ]", "");
